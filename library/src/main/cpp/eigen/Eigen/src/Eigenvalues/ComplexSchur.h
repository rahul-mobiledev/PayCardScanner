...
/** \eigenvalues_module \ingroup Eigenvalues_Module
  ...
  */
    ...
    public:
        ...
        ComplexSchur &
        computeFromHessenberg(const HessMatrixType &matrixH, const OrthMatrixType &matrixQ,
                              bool computeU = true);
...
/** If m_matT(i+1,i) is neglegible in floating point arithmetic
  ...
  * return true, else return false. */
    ...
    inline bool ComplexSchur<MatrixType>::subdiagonalEntryIsNeglegible(Index i) {
        RealScalar d =
                numext::norm1(m_matT.coeff(i, i)) + numext::norm1(m_matT.coeff(i + 1, i + 1));
...
/* Reduce given matrix to Hessenberg form */
        ...
        struct complex_schur_reduce_to_hessenberg {
            ...
            static void
            run(ComplexSchur<MatrixType> &_this, const MatrixType &matrix, bool computeU) {
