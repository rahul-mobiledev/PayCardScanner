...
// forward declarations
        ...
        struct conj_helper<Scalar, Scalar, false, false> {
            ...
            EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE Scalar
            pmul(const Scalar &x, const Scalar &y) const { return internal::pmul(x, y); }
        };
        ...
        struct conj_helper<std::complex<RealScalar>, std::complex<RealScalar>, false, true> {
            ...
            EIGEN_STRONG_INLINE Scalar pmul(const Scalar &x, const Scalar &y) const {
                return Scalar(numext::real(x) * numext::real(y) + numext::imag(x) * numext::imag(y),
                              numext::imag(x) * numext::real(y) -
                              numext::real(x) * numext::imag(y));
            }
        };
        ...
        struct get_factor<Scalar, typename NumTraits<Scalar>::Real> {
            ...
            run(const Scalar &x) { return numext::real(x); }
        };
