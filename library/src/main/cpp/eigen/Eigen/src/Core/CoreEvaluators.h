...
// so no need for more sophisticated dispatching.
        ...
        struct evaluator<PlainObjectBase<Derived> >
            ...
            void writePacket(Index index, const PacketType &x) {
                return pstoret<Scalar, PacketType, StoreMode>(const_cast<Scalar *>(m_data) + index,
                                                              x);
            }
...
// -------------------- Transpose --------------------
        ...
        struct unary_evaluator<Transpose<ArgType>, IndexBased>
            ...
            EIGEN_DEVICE_FUNC explicit unary_evaluator(const XprType &t) : m_argImpl(
                    t.nestedExpression()) {}
        ...
        struct unary_evaluator<CwiseUnaryOp<UnaryOp, ArgType>, IndexBased>
            ...
            PacketType packet(Index row, Index col) const {
                return m_functor.packetOp(
                        m_argImpl.template packet<LoadMode, PacketType>(row, col));
            }
...
// this is a binary expression
        ...
        struct binary_evaluator<CwiseBinaryOp<BinaryOp, Lhs, Rhs>, IndexBased, IndexBased>
            ...
            enum {
                CoeffReadCost = evaluator<Lhs>::CoeffReadCost + evaluator<Rhs>::CoeffReadCost +
            ...
            PacketType packet(Index row, Index col) const {
                return m_functor.packetOp(m_lhsImpl.template packet<LoadMode, PacketType>(row, col),
                                          m_rhsImpl.template packet<LoadMode, PacketType>(row,
                                                                                          col));
            }
...
// but that might complicate template specialization
        ...
        struct mapbase_evaluator : evaluator_base<Derived> {
            ...
            void writePacket(Index index, const PacketType &x) {
                internal::pstoret<Scalar, PacketType, StoreMode>(
                        m_data + index * m_xpr.innerStride(), x);
            }
        ...
        struct evaluator<Map<PlainObjectType, MapOptions, StrideType> >
            ...
            enum {
                ...
                LinearAccessMask =
                bool(HasNoStride) || bool(PlainObjectType::IsVectorAtCompileTime) ? ~int(0) : ~int(
                        LinearAccessBit),
                Flags =
                int(evaluator<PlainObjectType>::Flags) & (LinearAccessMask & PacketAccessMask),
        ...
        struct evaluator<Block<ArgType, BlockRows, BlockCols, InnerPanel> >
            ...
            enum {
                ...
                FlagsLinearAccessBit = (RowsAtCompileTime == 1 || ColsAtCompileTime == 1 ||
                                        (InnerPanel &&
                                         (evaluator<ArgType>::Flags & LinearAccessBit)))
                                       ? LinearAccessBit : 0,
            ...
            EIGEN_DEVICE_FUNC explicit evaluator(const XprType &block) : block_evaluator_type(
                    block) {
                EIGEN_INTERNAL_CHECK_COST_VALUE(CoeffReadCost);
            }
        };
...
// no direct-access => dispatch to a unary evaluator
        ...
        struct unary_evaluator<Block<ArgType, BlockRows, BlockCols, InnerPanel>, IndexBased>
            ...
            template<int LoadMode, typename PacketType>
            PacketType packet(Index row, Index col) const {
                return m_argImpl.template packet<LoadMode, PacketType>(m_startRow.value() + row,
        ...
        protected:
            ...
            const variable_if_dynamic<Index,
                    ArgType::RowsAtCompileTime == 1 ? 0 : Dynamic> m_startRow;
            const variable_if_dynamic<Index,
                    ArgType::ColsAtCompileTime == 1 ? 0 : Dynamic> m_startCol;
        };
...
// all action is via the data() as returned by the Block expression.
        ...
        struct block_evaluator<ArgType, BlockRows, BlockCols, InnerPanel, /* HasDirectAccess */ true>
            ...
            EIGEN_DEVICE_FUNC explicit block_evaluator(const XprType &block)
                ...
                eigen_assert(((size_t(block.data()) %
...
// -------------------- Replicate --------------------
        ...
        struct unary_evaluator<Replicate<ArgType, RowFactor, ColFactor> >
            ...
            typedef typename XprType::CoeffReturnType CoeffReturnType;
            enum {
                Factor = (RowFactor == Dynamic || ColFactor == Dynamic) ? Dynamic : RowFactor *
                                                                                    ColFactor
            };
            ...
            enum {
                ...
                Flags =
                (evaluator<ArgTypeNestedCleaned>::Flags & (HereditaryBits | LinearAccessMask) &
                 ~RowMajorBit) | (traits<XprType>::Flags & RowMajorBit),
...
// -------------------- PartialReduxExpr --------------------
        ...
        struct evaluator<PartialReduxExpr<ArgType, MemberOp, Direction> >
            ...
            typedef typename XprType::Scalar Scalar;
            enum {
                TraversalSize = Direction == int(Vertical) ? int(ArgType::RowsAtCompileTime) : int(
...
// MatrixWrapper and ArrayWrapper evaluators.
        ...
        struct evaluator_wrapper_base
            ...
            EIGEN_DEVICE_FUNC explicit evaluator_wrapper_base(const ArgType &arg) : m_argImpl(
                    arg) {}
        ...
        struct evaluator<Diagonal<ArgType, DiagIndex> >
            ...
            enum {
                ...
                Flags = (unsigned int) evaluator<ArgType>::Flags &
                        (HereditaryBits | LinearAccessBit | DirectAccessBit) & ~RowMajorBit,
