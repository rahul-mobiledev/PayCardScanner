...
public:
    ...
    virtual const Rect
    CalcWorkingArea(Size frameSize, int captureAreaWidth, PayCardsRecognizerOrientation orienation);

    virtual const DetectedLineFlags
    DetectEdges(Mat &rawFrame, vector<ParametricLine> &edges, Mat &resultFrame);
