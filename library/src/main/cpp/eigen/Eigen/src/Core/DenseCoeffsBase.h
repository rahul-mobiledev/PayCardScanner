  ...
  */
    ...
    public:
        ...
        EIGEN_STRONG_INLINE PacketReturnType packet(Index row, Index col) const {
            ...
            return internal::evaluator<Derived>(
                    derived()).template packet<LoadMode, DefaultPacketType>(row, col);
        }
        ...
        EIGEN_STRONG_INLINE PacketReturnType packet(Index index) const {
            ...
            eigen_internal_assert(index >= 0 && index < size());
            return internal::evaluator<Derived>(
                    derived()).template packet<LoadMode, DefaultPacketType>(index);
        }
    ...
    namespace internal {
        ...
        struct first_aligned_impl<Alignment, Derived, false> {
            static inline Index run(const Derived &m) {
                return internal::first_aligned<Alignment>(&m.const_cast_derived().coeffRef(0, 0),
                                                          m.size());
            }
        };
...
/** \internal \returns the index of the first element of the array stored by \a m that is properly aligned with respect to \a Alignment for vectorization.
  ...
  */
        ...
        static inline Index first_default_aligned(const DenseBase<Derived> &m) {
            ...
            return internal::first_aligned<int(
                    unpacket_traits<DefaultPacketType>::alignment), Derived>(m);
        }
