...
static inline PayCardsRecognizerOrientation getFromJOrientation(int jWorkAreaOrientation) {
    switch (jWorkAreaOrientation) {
        case 1 :
            return PayCardsRecognizerOrientationPortrait; // WORK_AREA_ORIENTATION_PORTAIT
        case 2 :
            return PayCardsRecognizerOrientationPortraitUpsideDown; // WORK_AREA_ORIENTATION_PORTAIT_UPSIDE_DOWN
        case 3 :
...
Java_com_rahul_paycardscanner_ndk_RecognitionCoreNdk_nativeSetDataPath(JNIEnv *env,
                                                                       jobject instance,
                                                                       jstring path_) {
    std::string stdPath;
    ...
    g_core->SetPathDateLocalization0Model(
            stdPath + "DateLocalization/DateLocalizationL0.caffemodel");
    g_core->SetPathDateLocalization0Struct(
            stdPath + "DateLocalization/DateLocalizationL0.prototxt");
    g_core->SetPathDateLocalization1Model(
            stdPath + "DateLocalization/DateLocalizationL1.caffemodel");
    g_core->SetPathDateLocalization1Struct(
            stdPath + "DateLocalization/DateLocalizationL1.prototxt");
    g_core->SetPathDateLocalizationViola(stdPath + "DateLocalization/cascade_date.xml");

    g_core->SetPathNameLocalizationXModel(
            stdPath + "NameLocalization/NameLocalizationX.caffemodel");
    ...
    g_core->SetPathNameSpaceCharModel(
            stdPath + "NameRecognition/NameSpaceCharRecognition.caffemodel");
    g_core->SetPathNameSpaceCharStruct(
            stdPath + "NameRecognition/NameSpaceCharRecognition.prototxt");
    g_core->SetPathNameListTxt(stdPath + "NameRecognition/names.txt");
}

JNIEXPORT void JNICALL
Java_com_rahul_paycardscanner_ndk_RecognitionCoreNdk_nativeInit(JNIEnv *env, jclass type) {
...
JNIEXPORT void JNICALL
Java_com_rahul_paycardscanner_ndk_RecognitionCoreNdk_nativeSetRecognitionMode(JNIEnv *env,
                                                                              jobject instance,
...
JNIEXPORT void JNICALL
Java_com_rahul_paycardscanner_ndk_RecognitionCoreNdk_nativeDeploy(JNIEnv *env,
                                                                  jobject instance) {
    g_core->Deploy();
}

JNIEXPORT void JNICALL
Java_com_rahul_paycardscanner_ndk_RecognitionCoreNdk_nativeSetOrientation(JNIEnv *env,
                                                                          jobject instance,
                                                                          jint cardRectOrientation) {
    LOGI("nativeSetOrientation() orientation: %s",
         woOrientationName(getFromJOrientation(cardRectOrientation)));
    g_core->SetOrientation(getFromJOrientation(cardRectOrientation));
}

JNIEXPORT void JNICALL
Java_com_rahul_paycardscanner_ndk_RecognitionCoreNdk_nativeCalcWorkingArea(JNIEnv *env,
                                                                           jobject instance,
                                                                           jint frameWidth,
                                                                           jint frameHeight,
                                                                           jint captureAreaWidth,
                                                                           jobject dstRect) {
    LOGI("nativeCalcWorkingArea() size: %ux%u, width: %u", frameWidth, frameHeight,
         captureAreaWidth);
...
JNIEXPORT void JNICALL
Java_com_rahul_paycardscanner_ndk_RecognitionCoreNdk_nativeDestroy(JNIEnv *env, jclass type) {
    g_core = nullptr;
}

JNIEXPORT void JNICALL
Java_com_rahul_paycardscanner_ndk_RecognitionCoreNdk_nativeResetResult(JNIEnv *env,
                                                                       jobject instance) {
    g_core->ResetResult();
}

JNIEXPORT void JNICALL
Java_com_rahul_paycardscanner_ndk_RecognitionCoreNdk_nativeSetIdle(JNIEnv *env, jobject instance,
                                                                   jboolean idle) {
    g_core->SetIdle(idle);
...
Java_com_rahul_paycardscanner_ndk_RecognitionCoreNdk_nativeIsIdle(JNIEnv *env,
                                                                  jobject instance) {
    return (jboolean) g_core->IsIdle();
}

JNIEXPORT void JNICALL
Java_com_rahul_paycardscanner_ndk_RecognitionCoreNdk_nativeSetTorchStatus(JNIEnv *env,
                                                                          jobject instance,
                                                                          jboolean isTurnedOn) {
...
Java_com_rahul_paycardscanner_ndk_RecognitionCoreNdk_nativeProcessFrameYV12(JNIEnv *env,
                                                                            jobject instance,
                                                                            jint src_width,
                                                                            jint src_height,
                                                                            jint rotation,
