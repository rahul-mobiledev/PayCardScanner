...
e.g. If scaling from 640x360 to 1280x720 the step thru the source will be 0.0, stepping half a pixel
...
Box filter is only used for 2x down sample or more. Its based on integer sized boxes. Technically it
