...
class CameraManager {
    ...
    public synchronized void resumeProcessFrames() {
        if (DBG)
            Log.d(TAG, "resumeProcessFrames(); frames processed already: " + mIsProcessFramesActive);
    ...
    private synchronized void startProcessThread() {
        ...
        mProcessThread = new ProcessFrameThread(mAppContext, mCamera, new ProcessFrameThread.Callbacks() {
            ...
            public void onFrameProcessed(int newBorders) {
                if (mProcessFrameCallbacks != null)
                    mProcessFrameCallbacks.onFrameProcessed(newBorders);
        ...
        mCamera.setPreviewCallbackWithBuffer(new Camera.PreviewCallback() {
            ...
            public void onPreviewFrame(byte[] data, Camera camera) {
                ...
                if (DBG) {
                    ...
                    if (singleFrameCallback != null)
                        singleFrameCallback.onPreviewFrame(data, camera);
                }
