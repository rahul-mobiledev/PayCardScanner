...
import com.rahul.library.camera.gles.Drawable2d;
import com.rahul.library.camera.gles.EglCore;
import com.rahul.library.camera.gles.GlUtil;
import com.rahul.library.camera.gles.Sprite2d;
import com.rahul.library.camera.gles.Texture2dProgram;
import com.rahul.library.camera.gles.WindowSurface;
...
public final class RenderThread extends Thread {
    ...
    private final ScanManagerHandler mMainHandler;
    ...
    private void surfaceAvailable(SurfaceHolder holder, boolean newSurface) {
        if (DBG)
            Log.d(TAG, "surfaceAvailable() called with: " + "holder = [" + holder + "], newSurface = [" + newSurface + "]");
