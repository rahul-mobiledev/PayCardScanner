...
#pragma GCC diagnostic pop
        ...
        pscatter<std::complex<float>, Packet2cf>(std::complex<float> *to, const Packet2cf &from,
                                                 Index stride) {
        ...
        EIGEN_STRONG_INLINE Packet2cf pdiv<Packet2cf>(const Packet2cf &a, const Packet2cf &b) {
            ...
            return Packet2cf(_mm_div_ps(res.v, _mm_add_ps(s, _mm_castsi128_ps(
                    _mm_shuffle_epi32(_mm_castps_si128(s), 0xb1)))));
        }
...
// FIXME force unaligned store, this is a temporary fix
        ...
        struct palign_impl<Offset, Packet1cd> {
            ...
            run(Packet1cd & /*first*/, const Packet1cd & /*second*/) {
        ...
        template<>
        EIGEN_STRONG_INLINE Packet2cf
        pblend(const Selector<2> &ifPacket, const Packet2cf &thenPacket,
