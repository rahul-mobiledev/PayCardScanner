...
/** \internal copy the packet \a from to \a *to, (un-aligned store) */
        ...
        pscatter(Scalar *to, const Packet &from, Index /*stride*/) { pstore(to, from); }
...
/** \internal \returns the sum of the elements of \a a by block of 4 elements.
  ...
  */
        ...
        typename conditional<(unpacket_traits<Packet>::size % 8) ==
                             0, typename unpacket_traits<Packet>::half, Packet>::type
        predux4(const Packet &a) { return a; }
...
/** \internal \returns a packet with the coefficients rotated to the right in little-endian convention,
  ...
  */
        template<size_t offset, typename Packet>
        EIGEN_DEVICE_FUNC inline Packet protate(const Packet &a) {
