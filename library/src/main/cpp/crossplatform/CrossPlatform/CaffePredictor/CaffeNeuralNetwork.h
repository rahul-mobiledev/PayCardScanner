...
public:
    ...
    virtual bool Predict(const shared_ptr<INeuralNetworkDatumList> &datumList,
...
private:
    ...
    void
    ProcessResult(const caffe::Blob<float> *prob, shared_ptr<INeuralNetworkResultList> &resultList);
