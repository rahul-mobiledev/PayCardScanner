  ...
  */
    ...
    public:
        ...
        void factorize(const MatrixType &matrix) {
            ...
            this->m_info = (m_cholmodFactor->minor == m_cholmodFactor->n ? Success
                                                                         : NumericalIssue);
        ...
        void _solve_impl(const SparseMatrix <RhsScalar, RhsOptions, RhsIndex> &b,
        ...
        Scalar logDeterminant() const {
            ...
            if (m_cholmodFactor->is_super) {
                ...
                for (Index k = 0; k < nb_super_nodes; ++k) {
                    ...
                    Map<const Array<Scalar, 1, Dynamic>, 0, InnerStride<> > sk(x + px[k], ncols,
                                                                               InnerStride<>(
                                                                                       nrows + 1));
