...
namespace Eigen {
    ...
    namespace internal {
        ...
        struct quat_product<Architecture::SSE, Derived, OtherDerived, float, Aligned16> {
            ...
            run(const QuaternionBase<Derived> &_a, const QuaternionBase<OtherDerived> &_b) {
                Quaternion<float> res;
                const __m128 mask = _mm_setr_ps(0.f, 0.f, 0.f, -0.f);
                __m128 a = _a.coeffs().template packet<Aligned16>(0);
                __m128 b = _b.coeffs().template packet<Aligned16>(0);
                __m128 s1 = _mm_mul_ps(vec4f_swizzle1(a, 1, 2, 0, 2),
                                       vec4f_swizzle1(b, 2, 0, 1, 2));
                __m128 s2 = _mm_mul_ps(vec4f_swizzle1(a, 3, 3, 3, 1),
        ...
        struct quat_product<Architecture::SSE, Derived, OtherDerived, double, Alignment> {
            static inline Quaternion<double>
            run(const QuaternionBase<Derived> &_a, const QuaternionBase<OtherDerived> &_b) {
