  ...
  */
    ...
    namespace internal {
        ...
        struct ldlt_inplace<Lower> {
            ...
            static bool
            unblocked(MatrixType &mat, TranspositionType &transpositions, Workspace &temp,
                      SignMatrix &sign) {
                using std::abs;
                typedef typename MatrixType::Scalar Scalar;
                ...
                for (Index k = 0; k < size; ++k) {
                    ...
                    if (k != index_of_biggest_in_corner) {
                        ...
                        for (Index i = k + 1; i < index_of_biggest_in_corner; ++i) {
                            ...
                            mat.coeffRef(i, k) = numext::conj(
                                    mat.coeffRef(index_of_biggest_in_corner, i));
                            mat.coeffRef(index_of_biggest_in_corner, i) = numext::conj(tmp);
                        }
                        if (NumTraits<Scalar>::IsComplex)
                            mat.coeffRef(index_of_biggest_in_corner, k) = numext::conj(
            ...
            static bool
            update(MatrixType &mat, const TranspositionType &transpositions, Workspace &tmp,
