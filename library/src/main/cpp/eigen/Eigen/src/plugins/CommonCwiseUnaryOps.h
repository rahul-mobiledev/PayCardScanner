...
typedef CwiseUnaryOp<internal::scalar_multiple2_op<Scalar, std::complex<Scalar>>, const Derived>
...
operator*(const std::complex<Scalar> &scalar) const {
    return ScalarComplexMultipleReturnType(derived(), internal::scalar_multiple2_op<Scalar,
            std::complex<Scalar> >(scalar));
}
