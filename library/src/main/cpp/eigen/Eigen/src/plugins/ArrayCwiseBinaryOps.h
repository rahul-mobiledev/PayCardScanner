...
const CwiseBinaryOp<internal::scalar_min_op<Scalar>, const Derived,
...
const CwiseBinaryOp<internal::scalar_max_op<Scalar>, const Derived,
        const CwiseNullaryOp <internal::scalar_constant_op<Scalar>, PlainObject> >
#ifdef EIGEN_PARSED_BY_DOXYGEN
max
#else
...
pow(const ArrayBase <ExponentDerived> &exponents) const {
    return CwiseBinaryOp < internal::scalar_binary_pow_op < Scalar,
...
/** \returns an expression of \c *this with each coeff decremented by the constant \a scalar
  ...
  */
EIGEN_DEVICE_FUNC
inline const CwiseUnaryOp<internal::scalar_sub_op<Scalar>,
        const Derived>

operator-(const Scalar &scalar) const {
    return CwiseUnaryOp < internal::scalar_sub_op < Scalar > ,
    const Derived>(derived(), internal::scalar_sub_op<Scalar>(scalar));;
}

EIGEN_DEVICE_FUNC
friend inline const CwiseUnaryOp<internal::scalar_rsub_op<Scalar>,
        const Derived>

operator-(const Scalar &scalar, const EIGEN_CURRENT_STORAGE_BASE_CLASS <Derived> &other) {
    return CwiseUnaryOp < internal::scalar_rsub_op < Scalar > ,
